        ...
        <section id="wss-live" class="wss-live-area wss-pad" aria-labelledby="wss-live-title">
          ...
          <div class="wss-play-grid">
            ...
            <div class="wss-live-slot"><dialog open class="wss-live-panel" aria-label="WSS2 interactive workspace">
              <div class="wss-live-toolbar"><span>WSS2 <small>/ ORIGINAL SITE</small></span><div><button type="button" data-live-expand aria-expanded="false">EXPAND ↗</button><button type="button" data-live-stop hidden>STOP ×</button></div></div>
